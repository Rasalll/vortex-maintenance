        ...
        <div className="relative rounded-[2.5rem] overflow-hidden glass border border-vortex-green/20 p-8 sm:p-14 lg:p-16 mb-16">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl bg-vortex-green/10 border border-vortex-green/20 mb-6 shadow-glow-green-sm">
              ...
              />
              <span className="text-xs font-mono font-bold tracking-[0.2em] uppercase text-vortex-green">
                VORTEX ACADEMY
              </span>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#programs"
                className="inline-flex items-center gap-2 rounded-full bg-vortex-green px-7 py-3.5 text-sm font-semibold text-white transition-all duration-300 hover:shadow-glow-green hover:scale-105"
              >
              ...
              <button
                onClick={onBack}
                className="inline-flex items-center gap-2 rounded-full glass px-7 py-3.5 text-sm font-semibold text-slate-800 transition-all duration-300 hover:border-vortex-green/40 hover:bg-white"
              >
                Return to Services
              </button>
            </div>
          ...
          {/* Quick Metrics Bar */}
          <div className="relative z-10 mt-14 grid grid-cols-2 sm:grid-cols-4 gap-6 border-t border-slate-200 pt-8">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="text-slate-900 font-bold text-xl leading-none font-display">6 Core</div>
                <div className="text-slate-500 text-xs mt-1">Specialized Tracks</div>
              </div>
            </div>
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-vortex-green/10 border border-vortex-green/20 grid place-items-center shrink-0">
              ...
              <div>
                <div className="text-slate-900 font-bold text-xl leading-none font-display">Flexible</div>
                <div className="text-slate-500 text-xs mt-1">Class Schedules</div>
              </div>
            </div>
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-vortex-green/10 border border-vortex-green/20 grid place-items-center shrink-0">
              ...
              <div>
                <div className="text-slate-900 font-bold text-xl leading-none font-display">Direct</div>
                <div className="text-slate-500 text-xs mt-1">Industry Mentorship</div>
              </div>
            </div>
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-vortex-green/10 border border-vortex-green/20 grid place-items-center shrink-0">
              ...
              <div>
                <div className="text-slate-900 font-bold text-xl leading-none font-display">100%</div>
                <div className="text-slate-500 text-xs mt-1">Practical Execution</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {PROGRAMS.map((p: Program) => {
              ...
              return (
                <div
                  key={p.id}
                  className="group relative flex flex-col justify-between rounded-3xl glass p-8 transition-all duration-500 hover:-translate-y-2 hover:border-vortex-green/40 hover:shadow-xl hover:bg-white"
                >
                  <div>
                    <div className="flex items-center justify-between gap-3 mb-6">
                      ...
                      <span className="text-xs font-mono font-semibold uppercase tracking-wider text-vortex-green bg-vortex-green/10 px-3 py-1 rounded-full border border-vortex-green/20">
                        {p.badge}
                      </span>
                    </div>
                  ...
                  <div className="mt-8 pt-5 border-t border-slate-200 flex items-center justify-between text-xs font-semibold text-vortex-green">
        ...
        <div className="rounded-[2.5rem] glass border border-slate-200 p-8 sm:p-14">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-3xl bg-white border border-slate-200 p-8 text-center relative overflow-hidden shadow-xl">
              ...
              <button
                onClick={onBack}
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-vortex-green px-8 py-3.5 text-sm font-semibold text-white transition-all duration-300 hover:shadow-glow-green hover:scale-105"
              >
                Back to All Services
              </button>
            </div>
