...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative pt-28 pb-10 overflow-hidden border-t border-white/5">
      <div className="absolute top-0 left-1/4 w-80 h-80 bg-vortex-purple/5 blur-[120px] rounded-full" />

      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        {/* CTA banner */}
        <div className="reveal relative overflow-hidden rounded-3xl glass border border-vortex-purple/20 p-8 sm:p-12 mb-16 text-center">
          <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-80 h-60 bg-vortex-purple/15 blur-[100px] rounded-full" />
          <div className="relative">
            <h3 className="font-display font-bold text-white text-3xl sm:text-4xl">
              Ready to build the <span className="text-vortex-purple">future?</span>
            </h3>
            ...
            <button
              onClick={() => go('services')}
              className="mt-7 inline-flex items-center gap-2 rounded-full bg-vortex-purple px-7 py-3.5 text-sm font-semibold text-vortex-black transition-all duration-300 hover:shadow-glow hover:scale-105"
            >
              Explore Programs
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="reveal md:col-span-1">
            <div className="flex items-center gap-2.5">
              <span className="relative">
                <Hexagon className="w-8 h-8 text-vortex-purple" strokeWidth={1.5} />
          ...
          <div className="reveal" data-reveal-delay="100">
            <p className="text-vortex-purple font-mono text-[11px] tracking-[0.25em] uppercase mb-5">
              Navigate
            </p>
            <ul className="space-y-3">
              {NAV.map((n) => (
                <li key={n.id}>
                  <button
                    onClick={() => go(n.id)}
                    className="text-sm text-vortex-gray/70 hover:text-vortex-purple transition-colors"
                  >
                    {n.label}
                  </button>
                </li>
                  ...
                  <li key={c.label}>
                    ...
                    >
                      ...
                      <span className="min-w-0">
                        ...
                        <span className="block group-hover:text-vortex-purple transition-colors break-words">
                          {c.value}
                        </span>
                      </span>
                    </a>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-vortex-gray/50 font-mono">
            Learn Today. <span className="text-vortex-purple">Lead Tomorrow.</span>
          </p>
        </div>
      </div>
    </footer>
