  ...
  return (
    <section id="vision" className="relative py-28 sm:py-36 overflow-hidden">
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        <div className="reveal relative overflow-hidden rounded-[2rem] glass border border-vortex-green/15 p-10 sm:p-16 text-center">
          {/* glow */}
          <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-96 h-72 bg-vortex-green/15 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div className="relative">
            ...
            <div className="mt-10 inline-flex items-center gap-2 text-vortex-green/70 text-sm font-mono">
